...
{
    // Playwright login can take up to 2 minutes on first attempt; 5-second connect timeout
    // gives fast failure when the PA service is unreachable for any other operation.
