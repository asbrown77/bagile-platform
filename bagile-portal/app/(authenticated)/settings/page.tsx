...
import { ApiKey, CreateKeyResponse, PortalAuthError, loginWithGoogle, listKeys, createKey, revokeKey, PostCourseTemplate, listPostCourseTemplates, upsertPostCourseTemplate, PreCourseTemplate, getPreCourseTemplates, updatePreCourseTemplate, Trainer, getTrainers, createTrainer, updateTrainer, deleteTrainer, getServiceConfig, setServiceConfig, CourseDef, getCourseDefinitions, updateCourseBadgeUrl, updateCourseDuration, updateCourseName, getCourseAliases, addCourseAlias, deleteCourseAlias, createCourseDefinition } from "@/lib/api";
